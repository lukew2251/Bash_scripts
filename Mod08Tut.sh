...
#create employee_array for employee_string
...
#write the employee datat out to employee.csv in the mod08t directory
array_len=${#employe_array[*]}
...
#sort and unique the aray of cities
city_array=($(
	for i in ${city_array[*]};
	do
		echo $i
...
#addd last names to city string in array
